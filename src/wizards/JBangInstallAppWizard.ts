...
export default class JBangInstallAppWizard {
    ...
    private async inputAppName(input: MultiStepInput, state: Partial<InstallAppState>) {
    ...
    private async selectNative(input: MultiStepInput, state: Partial<InstallAppState>) {
